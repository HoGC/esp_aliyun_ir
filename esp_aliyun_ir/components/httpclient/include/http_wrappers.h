...
#define HAL_Printf(...)        
// #define HAL_Printf(...)   do{printf(__VA_ARGS__);}while(0)     
#define http_info(...)    do{HAL_Printf("[httpclient] [I] ");HAL_Printf(__VA_ARGS__);HAL_Printf("\r\n");}while(0)
#define http_err(...)     do{HAL_Printf("[httpclient] [E] ");HAL_Printf(__VA_ARGS__);HAL_Printf("\r\n");}while(0)
#define http_debug(...)   do{HAL_Printf("[httpclient] [D] ");HAL_Printf(__VA_ARGS__);HAL_Printf("\r\n");}while(0)
